	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FirewallV1alpha1().Rules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FirewallV1alpha1().Rules(namespace).Watch(context.TODO(), options)
			},
		},
		&firewallv1alpha1.Rule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *ruleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&firewallv1alpha1.Rule{}, f.defaultInformer)
}
