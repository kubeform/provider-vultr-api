...
import (
	...
	v1alpha1 "kubeform.dev/provider-vultr-api/client/listers/reserved/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ReservedV1alpha1().Ips(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ReservedV1alpha1().Ips(namespace).Watch(context.TODO(), options)
			},
		},
		&reservedv1alpha1.Ip{},
		resyncPeriod,
...
func (f *ipInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&reservedv1alpha1.Ip{}, f.defaultInformer)
}
