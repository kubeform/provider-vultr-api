...
import (
	...
	v1alpha1 "kubeform.dev/provider-vultr-api/client/listers/block/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BlockV1alpha1().Storages(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BlockV1alpha1().Storages(namespace).Watch(context.TODO(), options)
			},
		},
		&blockv1alpha1.Storage{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *storageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&blockv1alpha1.Storage{}, f.defaultInformer)
}
