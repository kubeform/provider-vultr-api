...
type Interface interface {
	// FromURLs returns a FromURLInformer.
	FromURLs() FromURLInformer
...
// FromURLs returns a FromURLInformer.
func (v *version) FromURLs() FromURLInformer {
	return &fromURLInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
