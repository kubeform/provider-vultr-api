...
import (
	...
	bare "kubeform.dev/provider-vultr-api/client/informers/externalversions/bare"
	block "kubeform.dev/provider-vultr-api/client/informers/externalversions/block"
	dns "kubeform.dev/provider-vultr-api/client/informers/externalversions/dns"
	firewall "kubeform.dev/provider-vultr-api/client/informers/externalversions/firewall"
	...
	reserved "kubeform.dev/provider-vultr-api/client/informers/externalversions/reserved"
	reverse "kubeform.dev/provider-vultr-api/client/informers/externalversions/reverse"
	snapshot "kubeform.dev/provider-vultr-api/client/informers/externalversions/snapshot"
	ssh "kubeform.dev/provider-vultr-api/client/informers/externalversions/ssh"
	startup "kubeform.dev/provider-vultr-api/client/informers/externalversions/startup"
	user "kubeform.dev/provider-vultr-api/client/informers/externalversions/user"
...
type SharedInformerFactory interface {
	...
	Reverse() reverse.Interface
	Snapshot() snapshot.Interface
	Ssh() ssh.Interface
	Startup() startup.Interface
	User() user.Interface
}

func (f *sharedInformerFactory) Bare() bare.Interface {
	return bare.New(f, f.namespace, f.tweakListOptions)
}

func (f *sharedInformerFactory) Block() block.Interface {
	return block.New(f, f.namespace, f.tweakListOptions)
}
...
func (f *sharedInformerFactory) Reverse() reverse.Interface {
	return reverse.New(f, f.namespace, f.tweakListOptions)
}
...
func (f *sharedInformerFactory) Startup() startup.Interface {
	return startup.New(f, f.namespace, f.tweakListOptions)
}
