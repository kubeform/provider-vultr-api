...
type Interface interface {
	...
	// NodePoolses returns a NodePoolsInformer.
	NodePoolses() NodePoolsInformer
}
...
// NodePoolses returns a NodePoolsInformer.
func (v *version) NodePoolses() NodePoolsInformer {
	return &nodePoolsInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
