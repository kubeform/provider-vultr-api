...
type FakeStorages struct {
	Fake *FakeBlockV1alpha1
	ns   string
}

var storagesResource = schema.GroupVersionResource{Group: "block.vultr.kubeform.com", Version: "v1alpha1", Resource: "storages"}

var storagesKind = schema.GroupVersionKind{Group: "block.vultr.kubeform.com", Version: "v1alpha1", Kind: "Storage"}
