...
import (
	...
	v1alpha1 "kubeform.dev/provider-vultr-api/apis/user/v1alpha1"
...
var usersResource = schema.GroupVersionResource{Group: "user.vultr.kubeform.com", Version: "v1alpha1", Resource: "users"}

var usersKind = schema.GroupVersionKind{Group: "user.vultr.kubeform.com", Version: "v1alpha1", Kind: "User"}
