...
// SnapshotV1alpha1Client is used to interact with features provided by the snapshot.vultr.kubeform.com group.
type SnapshotV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SnapshotV1alpha1Client) FromURLs(namespace string) FromURLInterface {
	return newFromURLs(c, namespace)
}
