...
import (
	v1alpha1 "kubeform.dev/provider-vultr-api/apis/firewall/v1alpha1"
...
// FirewallV1alpha1Client is used to interact with features provided by the firewall.vultr.kubeform.com group.
type FirewallV1alpha1Client struct {
	restClient rest.Interface
}

func (c *FirewallV1alpha1Client) Groups(namespace string) GroupInterface {
	return newGroups(c, namespace)
}

func (c *FirewallV1alpha1Client) Rules(namespace string) RuleInterface {
